...
<body>
    <div class="container">
     ...
     <center><h2 class="heading"><br> View By Employee Information</h2></center>
             <div style="position:absolute;margin-top:50px;margin-left:20px;" id="print">
        <?php
...
if ($result->num_rows > 0) {
     echo "<table><tr><th>ID</th><th>Name</th><th>Assigned_Table</th><th>Designation</th><th class='dontprint'>Action</th><th class='dontprint'> Action</th><th class='dontprint'>Action</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>".$row["E_ID"]."</td><td>".$row["E_Name"]."</td><td>".$row["Assigned_Table"]."</td><td>".$row["Designation"]."</td><td class='dontprint'><a href='edit_employee.php?ID=".$row['E_ID']."' style='text-decoration: none' />Edit</a></td><td class='dontprint'><a href='delete_employee.php?ID=".$row['E_ID']."' style='text-decoration: none;' />Delete</a></td><td class='dontprint'><a href='print_employee.php?ID=".$row['E_ID']."' onclick='myWindow=window.open(this.ref 'newwindow','width=300,height=250')';>Print</a></td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
